...
class GroupCenterCrop(object):
    def __init__(self, input_size):
        self.worker = T.CenterCrop(input_size)
...
class GroupScale(object):
    ...
    def __init__(self, scale_size, interpolation=TF.InterpolationMode.BICUBIC):
        self.worker = T.Resize(scale_size, interpolation)
